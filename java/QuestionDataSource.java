...
public class QuestionDataSource {
	...
	Context context;
	private final String[] cols = { MySQLiteHelper.COLUMN_ID,
			MySQLiteHelper.COLUMN_QNUM, MySQLiteHelper.COLUMN_QUESTION,
			MySQLiteHelper.COLUMN_ANSWER, MySQLiteHelper.COLUMN_POINTS,
			MySQLiteHelper.COLUMN_STATUS, MySQLiteHelper.COLUMN_LAT,
			MySQLiteHelper.COLUMN_LONG, MySQLiteHelper.COLUMN_HINT };
	...
	public Question createQuestion(String qNum, String qs, String answer,
			String points, int status, String latitute, String longitute,
			String hint) {
		...
		long insertId = database.insert(MySQLiteHelper.TABLE_QUESTIONS, null,
				values);
		Cursor cursor = database.query(MySQLiteHelper.TABLE_QUESTIONS, cols,
				MySQLiteHelper.COLUMN_ID + " = " + insertId, null, null, null,
				null);
		cursor.moveToFirst();
		Question newq = cursorToQuestion(cursor);
		cursor.close();
		// Toast.makeText(context, newq.getQuestion(),
	...
	public void deleteQuestion(Question question) {
		...
		database.delete(MySQLiteHelper.TABLE_QUESTIONS,
				MySQLiteHelper.COLUMN_ID + " = " + id, null);
	}

	public void KeepQuestion(long ide) {
		long id = ide;
	...
	public void updateStatus(Question q) {
		...
		database.update(MySQLiteHelper.TABLE_QUESTIONS, values,
				MySQLiteHelper.COLUMN_ID + " = " + String.valueOf(q.getId()),
				null);
	}
	...
	public void deleteAll() {
		database.execSQL("DROP TABLE IF EXISTS "
				+ MySQLiteHelper.TABLE_QUESTIONS);
