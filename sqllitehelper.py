...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_CREATE = "create table "
			...
			+ " integer primary key autoincrement, " + COLUMN_QNUM
			+ " text not null, " + COLUMN_QUESTION + " text not null,"
			+ COLUMN_ANSWER + " text not null," + COLUMN_POINTS
			+ " text not null," + COLUMN_STATUS + " ," + COLUMN_LAT + " ,"
			+ COLUMN_LONG + " ," + COLUMN_HINT + ");";
